...
// d3.csv("data/water.csv", function(error, data) {
//   var yearNames = d3.keys(data[0]).filter(function(key) { 
//     return (key !== "region" && key !== "användargrupp"); 
//   });

//   data.forEach(function(d) {
//     d.years = yearNames.map(function(name) { 
